...
class HotelPetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel_pet" do
    assert_difference("HotelPet.count") do
      post hotel_pets_url, params: { hotel_pet: { address: @hotel_pet.address, bio: @hotel_pet.bio, continent: @hotel_pet.continent, name: @hotel_pet.name, price: @hotel_pet.price, rating: @hotel_pet.rating } }, as: :json
    end
  ...
  test "should update hotel_pet" do
    patch hotel_pet_url(@hotel_pet), params: { hotel_pet: { address: @hotel_pet.address, bio: @hotel_pet.bio, continent: @hotel_pet.continent, name: @hotel_pet.name, price: @hotel_pet.price, rating: @hotel_pet.rating } }, as: :json
    assert_response :success
  end
